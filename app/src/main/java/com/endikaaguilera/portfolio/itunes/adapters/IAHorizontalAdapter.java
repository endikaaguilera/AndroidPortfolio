...
package com.endikaaguilera.portfolio.itunes.adapters;
...
import com.endikaaguilera.portfolio.GlideApp;
    ...
    public FestivitiesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        if (this.placeholderIcon == null)
            this.placeholderIcon =
                    ContextCompat.getDrawable(parent.getContext(), R.drawable.ic_ia_placeholder); // fixme - replace this icon...
